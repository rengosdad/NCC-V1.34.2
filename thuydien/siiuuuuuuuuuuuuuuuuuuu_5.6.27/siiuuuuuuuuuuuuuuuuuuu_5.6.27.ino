...
//Khởi động LCD
 ...
 void loop()
 {
  ...
  //lcd.print("0");//(scale.get_units(5), 1)
  ...
  double T,P,p0,a;
   ...
   status = pressure.getPressure(P,T);
      ...
      //Tc=(T,2);
          ...
          Serial.print(P/10-127.950,0);//(P/10-127.985,2)
          Serial.println(" kPa, ");
           lcd.setCursor(0,1);
  lcd.print("Pr= ");
  lcd.setCursor(4,1);

  lcd.print((P/10-127.950,0));//
  
  lcd.print(" KPa");
    //Pr=(P/10-127.950,0);
          Serial.print("met nuoc: ");
          Serial.print(P/10*0.101974-13.005,0);//
          Serial.println(" mH2O, ");
          //H=(P/10*0.101974-13.005,0);
...
bt.print(L);//lưu lượng send distance to MIT App
 ...
 bt.print(";");
 bt.print(H);//cao cot h2o send distance to MIT App 
 bt.print(";");
 bt.print(Tc);//cao cot h2o send distance to MIT App 
 bt.print(";");
