...
//  Serial.print("Hiện tại: "); Serial.println(hientai);
 ...
 for(int i = 0; i < 1000; i++) {
     bawn = average = average + (.0264 * analogRead(A0) -13.51);//for the 5A mode,  
...
bt.print("1");//lưu lượng send distance to MIT App
 bt.print(";");
  bt.print(scale.get_units(5), 1); //áp xuất send distance to MIT App 
 bt.print(";");
 bt.print(l_hour);//lưu lượng send distance to MIT App
 bt.print(";");
 bt.print(rpm);//tốc độ tuabin send distance to MIT App 
 bt.print(";");
 bt.print(bawn/1000 + 0.08);//dong dien tuabin send distance to MIT App 
 bt.print(";");
